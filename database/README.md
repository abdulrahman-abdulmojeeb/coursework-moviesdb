...
- **rating** — User ratings on a 0.5–5.0 scale with timestamps
- **tag** — Free-text user-generated tags with timestamps
- **link** — External database identifiers (IMDb, TMDB)

### External Enrichment
- **movie_detail** — TMDB data: posters, backdrops, overviews, runtime, budget, revenue, cast, crew
