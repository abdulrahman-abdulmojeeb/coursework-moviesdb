...
export const stackSections: StackSection[] = [
  ...
  },
  {
    ...
    technologies: [
      ...
      { name: "GroupLens Personality ISF 2018", version: "ISF 2018", description: "Big Five personality traits (OCEAN, 1-7 scale) for 1,820 users with predicted ratings for up to 12 movies each", link: "https://files.grouplens.org/datasets/personality-isf2018/" },
    ],
  },
  {
...
export const databaseSchema = [
  ...
  { table: "personality_dataset_user", records: "1,820", description: "Big Five personality traits (openness, agreeableness, etc.) on 1\u20137 scale from GroupLens ISF 2018 dataset" },
  { table: "personality_predicted_rating", records: "19,021", description: "Predicted ratings per user-movie pair from the ISF 2018 personality dataset" },
